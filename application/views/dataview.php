                ...
                <div class="row">
                    ...
                    foreach ($penilaian as $data_nilai) { ?>
                                            <tr>
                                                ...
                                                <td><?php echo $data_nilai->kesimpulan; ?></td>
                                                <td>
                                                    <a href="<?php echo base_url(); ?>index.php/dashboard/detail/<?php echo $data_nilai->nik;?>" class="btn btn-info btn-sm"><i class="glyphicon glyphicon-search"></i> Lihat</a>
                                                </td>
                                            </tr> <?php } ?>
                                </table>
                    </div>
