    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><center><b>FIT AND PROPER TEST </b></center></h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                ...
                <form method="post" id="penilaian" enctype="multipart/form-data" action="<?php echo base_url();?>index.php/dashboard/simpan">
                            <div class="form-group">
                                <label>NIK :</label>
