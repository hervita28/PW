                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?php echo base_url('index.php/user/detail')?>?nik=<?php echo $data['nik']?>&id=<?php echo $data['id']?>" class="btn btn-info btn-sm"><i class="glyphicon glyphicon-search"></i> Detail Nilai</a>
                                        </td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
